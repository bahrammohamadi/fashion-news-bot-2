...
from openai import AsyncOpenAI  # برای async
...
async def main(event=None, context=None):
    ...
    rss_feeds = [  # لیست قبلی‌ات رو نگه داشتم
...
خلاصه انگلیسی: {summary_en}"""
        ...
        response = await client.chat.completions.create(
            model="qwen/qwen-max",  # یا "meta-llama/llama-3.1-405b-instruct:free" برای رایگان
